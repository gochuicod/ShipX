...
const Statistics = () => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
    id: "statistics",
    className: `relative flex md:flex-row flex-col-reverse justify-center items-center gap-x-[3vw] md:gap-y-0 gap-y-[10vw] md:pt-[15vw] pt-[40vw] lg:pb-0 md:pb-0 pb-[30vw] overflow-hidden select-none ${_utils_constants__WEBPACK_IMPORTED_MODULE_2__.margin}`,
...
//# sourceMappingURL=src_scripts_components_ui_Statistics_js.js.map?ver=da624a12a0c157ba16b2