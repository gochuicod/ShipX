...
/* harmony import */ var _icons_FooterIcons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../icons/FooterIcons */ "./src/scripts/icons/FooterIcons.jsx");
/* harmony import */ var _lib_util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../lib/util */ "./src/lib/util.js");
/* harmony import */ var _components_library_AppButton__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/library/AppButton */ "./src/scripts/components/library/AppButton.jsx");
...
const ContactItem = ({
  ...
  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(Icon, {
    className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_5__.cn)("shrink-0", iconClass)
  }), href ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("a", {
    href: href,
    className: _styles_themeGuide__WEBPACK_IMPORTED_MODULE_3__.themeGuide.footerItem,
    children: text
...
const FooterColumn = ({
  ...
  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("h3", {
    className: _styles_themeGuide__WEBPACK_IMPORTED_MODULE_3__.themeGuide.footerHeading + " mb-[3vw] md:mb-1",
    children: title
  }), children]
});
const FooterLinkList = ({
  ...
  children: links.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("li", {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_SmartNavLink__WEBPACK_IMPORTED_MODULE_2__["default"], {
      to: item.to,
      className: _styles_themeGuide__WEBPACK_IMPORTED_MODULE_3__.themeGuide.footerItem,
      children: item.label
    })
...
const Footer = (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(() => {
  ...
  const contactItems = [{
    icon: _icons_FooterIcons__WEBPACK_IMPORTED_MODULE_4__.MailIcon,
    text: t("footer.reach_us_3"),
    href: `mailto:${t("footer.reach_us_3")}`,
    itemClass: "items-center",
    iconClass: _styles_themeGuide__WEBPACK_IMPORTED_MODULE_3__.themeGuide.footerIcon
  }, {
    icon: _icons_FooterIcons__WEBPACK_IMPORTED_MODULE_4__.LocationIcon,
  ...
  const footerColumnData = [{
    ...
    content: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(FooterLinkList, {
      links: linkColumns.quickLinks
    })
  }, {
    id: "toolkitAndResources",
    isGroup: true,
    className: "md:col-start-2 lg:col-start-auto flex flex-col gap-[4vw] md:gap-4",
    items: [{
      id: "toolkit",
    ...
    items: [{
      ...
      content: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("ul", {
        className: "space-y-[3vw] md:space-y-[8.5px]",
        children: contactItems.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ContactItem, {
          ...item
        }, item.text))
      })
    }]
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
    className: "md:pt-[15vw] pt-[60vw] lg:mt-0 mt-[20vw] relative",
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
      className: " absolute lg:top-[5vw] md:top-[-8vw] top-0 left-0 right-0 mx-auto lg:w-[80vw] md:w-[92vw] w-[90vw] md:h-fit h-[80vw] rounded-3xl flex flex-col bg-linear-to-b from-[#4F378A] to-[#66005C] ",
      style: {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("span", {
          className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_5__.cn)(_styles_themeGuide__WEBPACK_IMPORTED_MODULE_3__.themeGuide.ctaHeading, "md:text-start text-center md:w-auto w-[70%]"),
          children: t("shipment_tracker.shipment_cta_section.title")
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("span", {
          className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_5__.cn)(_styles_themeGuide__WEBPACK_IMPORTED_MODULE_3__.themeGuide.ctaDescription, "opacity-90 font-light lg:w-[50%] md:w-[50%] md:pt-2 pt-0 md:text-start text-center"),
          children: t("shipment_tracker.shipment_cta_section.description")
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
          className: "flex flex-row gap-x-[3vw] md:gap-x-[1vw] mt-4",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_components_library_AppButton__WEBPACK_IMPORTED_MODULE_6__["default"], {
            to: "/book-a-demo",
            text: t("header.book_a_demo") || "Book a Demo",
            withLeftIcon: true,
            leftIcon: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(lucide_react__WEBPACK_IMPORTED_MODULE_7__["default"], {
              className: "size-5"
            })
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_components_library_AppButton__WEBPACK_IMPORTED_MODULE_6__["default"], {
            to: "/#contact-us",
          ...
          alt: "",
          className: " lg:w-auto md:w-[50%] h-auto absolute lg:top-[-9.5vw] md:top-0 top-[-26vw] md:right-[-4vw] right-0 justify-end "
        })]
      })]
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
        className: "flex flex-col lg:items-start md:items-center md:flex-col lg:flex-row gap-[3vw] md:gap-0",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
          className: "flex flex-col lg:justify-start lg:items-start justify-center items-center w-full lg:w-[37%] md:w-full md:mb-[0.5vw] mb-[3.5vw]",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
            ...
            className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_5__.cn)(_styles_themeGuide__WEBPACK_IMPORTED_MODULE_3__.themeGuide.footerTagline, "md:mb-[1vw] mb-[4vw] lg:text-start md:text-center text-center"),
            style: {
              fontFamily: "Karla, system-ui, -apple-system, sans-serif"
            },
            children: t("footer.tagline")
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("p", {
            className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_5__.cn)(_styles_themeGuide__WEBPACK_IMPORTED_MODULE_3__.themeGuide.footerBody, "lg:text-start md:text-center text-center md:w-[65%] lg:w-[85%] lg:mt-0 md:mt-2"),
            children: [t("footer.description_1"), " ", t("footer.description_2")]
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          className: " w-full lg:w-[70%] md:w-[90%] grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-[4vw] md:gap-4 auto-rows-min lg:my-0 md:my-6 ",
          children: footerColumnData.map(col => {
            if (col.isGroup) {
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
                className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_5__.cn)(col.className, "gap-[4vw] md:gap-4"),
                children: col.items.map((item, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(FooterColumn, {
                  title: item.title,
                  className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_5__.cn)(
                  // If it's the Legal/Contact group...
                  col.id === "legalAndContact" && index === 0 ? "lg:col-start-3" : "lg:col-start-4"),
            ...
            // Quick Links
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
              className: "md:col-start-1 lg:col-start-1",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(FooterColumn, {
                title: col.title,
        ...
        className: "mt-[4vw] md:mt-4 flex flex-col md:flex-row justify-between items-center text-dark-neutral font-normal text-[3vw] md:text-base pt-[4vw] md:pt-0",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_SmartNavLink__WEBPACK_IMPORTED_MODULE_2__["default"], {
            ...
            children: "\u2022"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_ui_SmartNavLink__WEBPACK_IMPORTED_MODULE_2__["default"], {
            to: "privacy-policy",
            end: true,
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("span", {
...
//# sourceMappingURL=src_scripts_components_Footer_jsx.js.map?ver=3be1c5cec1e7c3a849cc