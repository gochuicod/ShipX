...
/* harmony import */ var _styles_themeGuide__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../styles/themeGuide */ "./src/styles/themeGuide.js");
/* harmony import */ var _icons_FooterIcons__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../icons/FooterIcons */ "./src/scripts/icons/FooterIcons.jsx");
/* harmony import */ var _lib_util__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../lib/util */ "./src/lib/util.js");
...
/* harmony import */ var _components_library_AppButton__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/library/AppButton */ "./src/scripts/components/library/AppButton.jsx");
/* harmony import */ var _components_library_Dropdown__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/library/Dropdown */ "./src/scripts/components/library/Dropdown.jsx");
/* harmony import */ var _components_library_LoginModal__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/library/LoginModal */ "./src/scripts/components/library/LoginModal.jsx");
...
const ContactItem = ({
  ...
  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(Icon, {
    className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_7__.cn)("shrink-0", iconClass)
  }), href ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("a", {
    href: href,
    className: _styles_themeGuide__WEBPACK_IMPORTED_MODULE_5__.themeGuide.footerItem,
    children: text
...
const FooterColumn = ({
  ...
  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("h3", {
    className: _styles_themeGuide__WEBPACK_IMPORTED_MODULE_5__.themeGuide.footerHeading + " mb-[3vw] md:mb-1",
    children: title
  }), children]
});
const FooterLinkList = ({
  ...
  children: links.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("li", {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_ui_SmartNavLink__WEBPACK_IMPORTED_MODULE_4__["default"], {
      to: item.to,
      className: _styles_themeGuide__WEBPACK_IMPORTED_MODULE_5__.themeGuide.footerItem,
      children: item.label
    })
...
const Footer = (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(() => {
  ...
  const [selectedLanguage, setSelectedLanguage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(_utils_constants__WEBPACK_IMPORTED_MODULE_8__.languages[0]);
  const handleLanguageChange = async language => {
    ...
    try {
      ...
      if (_utils_constants__WEBPACK_IMPORTED_MODULE_8__.languages.some(l => l.key === segments[0])) {
        segments.shift();
      }
  ...
  const [selected, setSelected] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(() => {
    ...
    return _utils_constants__WEBPACK_IMPORTED_MODULE_8__.languages.find(language => language.key === current) || _utils_constants__WEBPACK_IMPORTED_MODULE_8__.languages[0];
  });
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    const currentLang = i18n.language || localStorage.getItem("lang") || "en";
    const matched = _utils_constants__WEBPACK_IMPORTED_MODULE_8__.languages.find(lang => lang.key === currentLang);
  ...
  const contactItems = [{
    icon: _icons_FooterIcons__WEBPACK_IMPORTED_MODULE_6__.MailIcon,
    text: t("footer.reach_us_3"),
    href: `mailto:${t("footer.reach_us_3")}`,
    itemClass: "items-center",
    iconClass: _styles_themeGuide__WEBPACK_IMPORTED_MODULE_5__.themeGuide.footerIcon
  }, {
    icon: _icons_FooterIcons__WEBPACK_IMPORTED_MODULE_6__.LocationIcon,
  ...
  const footerColumnData = [{
    ...
    content: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(FooterLinkList, {
    ...
    items: [{
      ...
      content: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("ul", {
        className: "space-y-[3vw] md:space-y-[8.5px]",
        children: contactItems.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(ContactItem, {
          ...item
        }, item.text))
      })
    }]
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
    className: "md:pt-[100px] pt-[150px] relative overflow-hidden",
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
      className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_7__.cn)("bg-linear-to-b from-[#4F378A] from-[0%] to-[#66005C] to-[95%]", "w-[90%]", "md:min-h-auto min-h-[383px]", "md:w-[95%]", "xl:w-full", "max-w-[1440px]", "absolute", "top-[70px]", "left-1/2", "-translate-x-1/2", "z-10", "rounded-[24px]", "flex flex-row", "md:items-center items-end", "justify-between", "px-8 md:px-16 py-10", "text-['Inter']", "relative"),
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("div", {
        className: "absolute w-[256px] h-64 bg-[#FF00E5]/20 blur-3xl rounded-full top-1 left-0 -z-5"
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("div", {
        className: "absolute w-[256px] h-64 bg-[#FF00E5]/20 blur-3xl rounded-full top-1 right-0 -z-5"
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
        className: "flex flex-col",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
          className: "2xl:text-[32px] text-[28px] leading-[32px] font-semibold text-white md:text-start text-center",
          children: t("shipment_tracker.shipment_cta_section.title")
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
          className: "md:w-[65%] w-full font-normal text-white md:text-start text-center",
          children: t("shipment_tracker.shipment_cta_section.description")
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
          className: "flex flex-row md:justify-start justify-center gap-3 mt-6",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_library_AppButton__WEBPACK_IMPORTED_MODULE_9__["default"], {
            to: "/book-a-demo",
            text: t("header.book_a_demo") || "Book a Demo",
            withLeftIcon: true,
            leftIcon: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(lucide_react__WEBPACK_IMPORTED_MODULE_2__["default"], {
              className: "size-5"
            })
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_library_AppButton__WEBPACK_IMPORTED_MODULE_9__["default"], {
            to: "/#contact-us",
            text: t("header.contact_us") || "Contact Us",
            variant: "secondary",
            withLeftIcon: true,
            leftIcon: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(lucide_react__WEBPACK_IMPORTED_MODULE_3__["default"], {
        ...
        className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_7__.cn)("h-auto md:w-[50%] w-full", "absolute", "2xl:right-0 md:right-[-50px] right-auto", "md:left-auto left-1/2 md:translate-none -translate-x-1/2", "2xl:bottom-[-30px] md:bottom-[5px] bottom-[220px]", "-z-5")
      })]
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
        className: "flex flex-col xl:items-start md:items-center md:flex-col xl:flex-row gap-[3vw] md:gap-0 max-w-[1440px] mx-auto",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
            ...
            className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_7__.cn)(_styles_themeGuide__WEBPACK_IMPORTED_MODULE_5__.themeGuide.footerTagline, "md:mb-[1vw] mb-[4vw] xl:text-start md:text-center text-center"),
            style: {
              fontFamily: "Karla, system-ui, -apple-system, sans-serif"
            },
            children: t("footer.tagline")
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("p", {
            className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_7__.cn)(_styles_themeGuide__WEBPACK_IMPORTED_MODULE_5__.themeGuide.footerBody, "xl:text-start md:text-center text-center md:w-[65%] xl:w-[85%] xl:mt-0 md:mt-2"),
            children: [t("footer.description_1"), " ", t("footer.description_2")]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
            className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_7__.cn)("flex flex-row", "gap-2", "xl:justify-center", "xl:items-center", "mt-3"),
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_library_Dropdown__WEBPACK_IMPORTED_MODULE_10__["default"], {
              title: "Language",
              items: _utils_constants__WEBPACK_IMPORTED_MODULE_8__.languages,
              selected: selectedLanguage,
              onSelect: language => handleLanguageChange(language),
              direction: "up",
              parentClassName: (0,_lib_util__WEBPACK_IMPORTED_MODULE_7__.cn)("bg-white hover:bg-secondary-hover active:bg-secondary-active", "border border-violet-300 active:border-secondary-active", "text-primary active:text-white cursor-pointer font-normal", "shadow-[1px_1px_2px_rgba(0,0,0,0.3),inset_-2px_-2px_6px_rgba(167,139,250,0.3)]", "rounded-md"),
              triggerClassName: "px-4 py-[5px] flex items-center justify-center"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_library_LoginModal__WEBPACK_IMPORTED_MODULE_11__["default"], {
              footer: true,
              placement: "top"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_library_AppButton__WEBPACK_IMPORTED_MODULE_9__["default"], {
              to: "/book-a-demo",
          ...
          className: "\r w-full xl:w-[70%] md:w-[90%]\r grid grid-cols-1\r md:grid-cols-3\r xl:grid-cols-4\r gap-[4vw] md:gap-4\r auto-rows-min\r xl:my-0 md:my-6\r ",
          children: footerColumnData.map(col => {
            if (col.isGroup) {
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("div", {
                className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_7__.cn)(col.className, "gap-[4vw] md:gap-4"),
                children: col.items.map((item, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(FooterColumn, {
                  title: item.title,
                  className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_7__.cn)(
            ...
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(FooterColumn, {
                title: col.title,
        ...
        className: "mt-[4vw] md:mt-4 flex flex-col md:flex-row justify-between items-center text-dark-neutral font-normal text-[14px] pt-[4vw] md:pt-0 max-w-[1440px] mx-auto",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_ui_SmartNavLink__WEBPACK_IMPORTED_MODULE_4__["default"], {
            ...
            children: "\u2022"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_ui_SmartNavLink__WEBPACK_IMPORTED_MODULE_4__["default"], {
            to: "privacy-policy",
            end: true,
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
...
//# sourceMappingURL=src_scripts_components_Footer_jsx.js.map?ver=3e7e4050ab31caf4af59