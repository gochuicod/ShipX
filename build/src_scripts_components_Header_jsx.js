...
function Dropdown({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
      className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_0__.cn)(linkClass, "flex items-center gap-x-1 cursor-pointer py-4", "group-hover:text-[#FF00E5]"),
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("span", {
        ...
        viewBox: "0 0 24 24",
        strokeWidth: 2.5,
        className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_0__.cn)("w-3 h-3 transition-transform duration-300", "group-hover:rotate-180 group-hover:stroke-[#FF00E5] stroke-[#1A1A1A]"),
      ...
      className: " absolute top-full left-0 z-50 mt-1 min-w-max  bg-white rounded-lg border border-[#FF00E5] shadow-lg p-1 overflow-hidden opacity-0 invisible translate-y-1 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-200 ease-out pointer-events-auto text-dark-netural ",
      children: items.map(item => onSelect ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
        role: "button",
        tabIndex: 0,
      ...
      }, item.id) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_ui_SmartNavLink__WEBPACK_IMPORTED_MODULE_1__["default"], {
        to: item.to,
...
const LoginModal = () => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
      ...
      className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_3__.cn)("flex items-center gap-x-1 cursor-pointer transition-colors duration-300", "text-nav font-normal text-base hover:text-[#FF00E5]", open && "text-[#FF00E5]" // Keep pink when open
      ),
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("span", {
        ...
        viewBox: "0 0 24 24",
        strokeWidth: 2.5,
        className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_3__.cn)("w-3 h-3 transition-transform duration-300", "stroke-[#1A1A1A]", open ? "rotate-180 stroke-[#FF00E5]" : "rotate-0"),
      ...
      className: " absolute top-full left-1/2 -translate-x-1/2 z-50 mt-2 md:mt-[1vw] w-[90vw] md:w-auto md:min-w-[50vw] bg-white rounded-2xl md:rounded-[1vw] border border-[#FF00E5] shadow-lg p-6 md:p-[2vw] ",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
        className: "grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-[2vw]",
        children: modalItems.map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("span", {
            ...
            className: "text-[#757577] text-sm md:text-base leading-relaxed font-normal max-w-[200px] md:max-w-none",
            children: item.desc
...
//# sourceMappingURL=src_scripts_components_Header_jsx.js.map?ver=836f5749902613480b6e