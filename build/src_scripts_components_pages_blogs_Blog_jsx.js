  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_ui_SEO__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("article", {
        className: `mx-auto ${_styles_themeGuide__WEBPACK_IMPORTED_MODULE_8__.themeGuide.paddingX} py-16`,
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
          className: "flex flex-col gap-4 items-center md:items-start max-w-[1034px] mx-auto mb-12",
          children: [post.tags && post.tags.length > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
            ...
            className: "text-3xl md:text-5xl font-semibold text-[#121212] leading-tight tracking-tight text-center md:text-left",
            children: post.title
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
            className: "flex flex-row items-center gap-6",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("span", {
              className: "text-[#4D525C]",
          ...
          className: "w-full max-w-[1248px] mx-auto h-52 md:h-[500px] rounded-3xl overflow-hidden relative mb-16",
          ...
          children: contentBlocks.map((block, index) => {
            ...
            if (block.type === "text_full") {
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
                className: "w-full max-w-[1034px] text-[#1E2939] opacity-90 text-base leading-[24px] font-['Source_Serif_Pro'] font-normal  [&>p]:mb-4 [&>h2]:text-2xl [&>h2]:font-bold [&>h2]:mb-4 [&>ul]:list-disc [&>ul]:pl-5 [&>ul]:mb-4",
            ...
            if (block.type === "split") {
              ...
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
                className: `w-full max-w-[1248px] flex flex-col lg:flex-row gap-8 items-start ${isEven ? "lg:flex-row" : "lg:flex-row-reverse"}`,
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
                  className: "w-full lg:w-[501px] h-[280px] lg:h-auto shrink-0 rounded-2xl overflow-hidden relative",
                  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("img", {
                    src: block.imageSrc,
                  ...
                  className: "w-full lg:w-[608px] flex-1 text-[#1A1A1A] opacity-90 text-base leading-[24px] font-['Source_Serif_Pro'] font-normal lg:font-bold [&>p]:mb-4 [&>h3]:text-xl [&>h3]:font-bold [&>h3]:mb-2 [&>ul]:list-disc [&>ul]:pl-5",
                  dangerouslySetInnerHTML: {
                    __html: block.content
                  }
                })]
          ...
          className: "max-w-[1034px] mx-auto mt-16",
...
//# sourceMappingURL=src_scripts_components_pages_blogs_Blog_jsx.js.map?ver=009404e17fa67b1302af