...
const ContactUsNew = () => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(_library_Container__WEBPACK_IMPORTED_MODULE_7__["default"], {
    className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_9__.cn)("flex 2xl:flex-row flex-col", "justify-center items-stretch", "relative", "gap-8", _styles_themeGuide__WEBPACK_IMPORTED_MODULE_8__.themeGuide.sectionPaddingY),
    style: {
      fontFamily: "Inter, sans-serif"
    },
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
      className: "w-1/3 max-2xl:w-full relative rounded-2xl overflow-hidden flex-shrink-0",
      ...
      className: "flex 2xl:flex-col flex-wrap gap-8 w-full",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
        ...
        className: "flex flex-row flex-wrap 2xl:flex-nowrap gap-2 2xl:gap-4 w-full",
        ...
        className: "flex flex-col w-full bg-linear-to-br from-[oklch(1_0_0_0)] to-[oklch(0.616_0.2539_333.97)]/24 rounded-2xl p-4 md:p-8",
...
//# sourceMappingURL=src_scripts_components_pages_homepage_ContactUsNew_jsx.js.map?ver=14847abfe340fcf26dd0