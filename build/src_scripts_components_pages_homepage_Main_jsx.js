...
const Blogs = (0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_lucide-react_dist_esm_icons_arrow-right_js-node_modules_lucide-react_dis-250bff"), __webpack_require__.e("src_scripts_components_pages_homepage_BlogsSection_jsx")]).then(__webpack_require__.bind(__webpack_require__, /*! ./BlogsSection */ "./src/scripts/components/pages/homepage/BlogsSection.jsx")));
...
const Main = () => {
  ...
  const heroSlides = [{
    id: 1,
    image: "https://cdn.jsdelivr.net/gh/gochuicod/ShipX@shipx-v2/src/assets/hero_section/hero_carousel_image_1.webp",
    bgClassName: (0,_lib_util__WEBPACK_IMPORTED_MODULE_2__.cn)("lg:bg-size-[60%_auto] md:bg-size-[80%_auto] bg-size-[700px_350px]", "lg:bg-position-[right_center] md:bg-position-[center_bottom] bg-position-[center_120%]", "bg-no-repeat"),
    ...
    id: 2,
    image: "https://cdn.jsdelivr.net/gh/gochuicod/ShipX@shipx-v2/src/assets/hero_section/hero_carousel_image_2.webp",
    bgClassName: (0,_lib_util__WEBPACK_IMPORTED_MODULE_2__.cn)("lg:bg-size-[60%_auto] md:bg-size-[80%_auto] bg-size-[700px_350px]", "lg:bg-position-[right_center] md:bg-position-[center_bottom] bg-position-[center_110%]", "bg-no-repeat"),
    ...
    id: 3,
    image: "https://cdn.jsdelivr.net/gh/gochuicod/ShipX@shipx-v2/src/assets/hero_section/hero_carousel_image_3.webp",
    bgClassName: (0,_lib_util__WEBPACK_IMPORTED_MODULE_2__.cn)("lg:bg-size-[60%_auto] md:bg-size-[80%_auto] bg-size-[700px_350px]", "lg:bg-position-[right_center] md:bg-position-[center_bottom] bg-position-[center_120%]", "bg-no-repeat"),
...
//# sourceMappingURL=src_scripts_components_pages_homepage_Main_jsx.js.map?ver=a5f2f5a4eb3de5a47b67