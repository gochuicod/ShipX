...
const SGAmiloCards = () => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(ParallaxSection, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
      className: `relative w-screen ${_utils_constants__WEBPACK_IMPORTED_MODULE_2__.margin} flex md:flex-row flex-col justify-center items-center md:gap-x-[3vw] gap-x-0 md:gap-y-0 gap-y-[10vw] md:pb-[10vw] pb-[25vw]`,
...
//# sourceMappingURL=src_scripts_components_ui_SGAmiloCards_js.js.map?ver=cbe12465253f16cea8f5