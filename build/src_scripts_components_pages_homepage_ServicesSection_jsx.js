...
function ServiceCard({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
      className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_0__.cn)("relative flex flex-col lg:flex-row items-center", "p-8 gap-8 rounded-2xl", "bg-[linear-gradient(135deg,rgba(242,148,255,0.2)_0%,rgba(255,230,255,0.1)_41.83%,rgba(242,148,255,0.2)_100%)]", "border border-white/50 shadow-sm"),
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
        className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_0__.cn)("relative", "w-full md:h-[272.58px] h-[200px]", "flex items-center justify-center"),
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("div", {
          className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_0__.cn)("absolute", "inset-0", "bg-gradient-to-br from-transparent via-[rgba(255,255,255,0.75)] to-[rgba(255,255,255,0.75)]", "border border-white rounded-lg", "box-border")
        ...
        className: "flex flex-col items-center lg:items-start w-full gap-5",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
          className: "flex flex-col gap-2 w-full text-center lg:text-left",
          ...
          className: "flex flex-col gap-1 w-full items-center lg:items-start",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("span", {
            ...
            className: "flex flex-row flex-wrap justify-center lg:justify-start items-center gap-3 mt-1",
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", {
            className: "font-['Inter'] font-bold text-[14px] leading-4 text-[#4D525C] text-center block",
            children: ctaText
          })
        })]
      })]
    }), pricingData.length > 0 && selectedService && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
      className: "flex flex-col items-center lg:items-start gap-2 self-stretch bg-white rounded-b-[12px] w-full",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("h4", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", {
          className: "font-['Inter'] font-bold lg:text-[16px] md:text-[15px] text-[14px] leading-4 text-[#4D525C] whitespace-nowrap truncate mr-2",
        ...
        className: "flex flex-row flex-wrap justify-center lg:justify-start items-start gap-[5px] w-full",
        children: pricingData.map((service, idx) => {
          ...
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("div", {
            ...
            className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_0__.cn)("flex flex-row justify-center items-center px-4 py-2 gap-2.5 rounded-sm h-8 cursor-pointer transition-all border", isSelected ? "bg-[#CC00B7] border-transparent" // Active Styles
            : "border-[#DAB2FF] hover:border-[#DAB2FF]/30" // Inactive Styles
            ),
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", {
              className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_0__.cn)("font-['Inter'] font-medium text-[14px] leading-4 whitespace-nowrap", isSelected ? "text-white font-bold" : "text-[#7F22FE]"),
...
function ServicesSection() {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(_library_Container__WEBPACK_IMPORTED_MODULE_11__["default"], {
    className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_3__.cn)("flex flex-col items-center overflow-hidden md:gap-8 gap-4", _styles_themeGuide__WEBPACK_IMPORTED_MODULE_4__.themeGuide.sectionPaddingY),
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
        className: "flex flex-col w-full lg:w-[35%] md:w-full items-center lg:items-end md:items-center text-center lg:text-right md:text-center",
        ...
        className: "flex flex-col flex-1 items-center lg:items-start md:items-center text-center lg:text-left md:text-center",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_library_Description__WEBPACK_IMPORTED_MODULE_9__["default"], {
          className: "mb-4 md:text-base text-sm lg:w-[85%] md:w-full w-full",
      ...
      className: "flex flex-col lg:flex-row justify-center items-center lg:items-start w-full gap-4 md:gap-8",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("div", {
        className: (0,_lib_util__WEBPACK_IMPORTED_MODULE_3__.cn)("flex lg:flex-col md:flex-wrap flex-wrap", "justify-center gap-4", "w-fit md:max-w-[704px] max-w-[376px]", "shrink-0"),
...
//# sourceMappingURL=src_scripts_components_pages_homepage_ServicesSection_jsx.js.map?ver=134c41675f5f21eafdf4