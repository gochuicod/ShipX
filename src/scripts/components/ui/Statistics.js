...
const Statistics = () => {
  ...
  return (
    <div
      id="statistics"
      className={`relative flex md:flex-row flex-col-reverse justify-center items-center gap-x-[3vw] md:gap-y-0 gap-y-[10vw] md:pt-[15vw] pt-[40vw] lg:pb-0 md:pb-0 pb-[30vw] overflow-hidden select-none ${margin}`}
    >
      <img
