    ...
    <div className="w-screen min-h-screen flex flex-col">
      ...
      >
        ...
        >
          ...
          >
            Your&nbsp;
            <span className="text-[#FF00E5]">HS Code AI Finder</span>
          </h2>
        </div>
        <p
          className="
                    ...
                    "
        >
          Input your product details, and let our system instantly handle the
          complexity of HTSUS (US) and HS (ROW) code selection, giving you the
          certainty required to ship anywhere.
        </p>
      </div>
