  ...
  return (
    <div className='relative overflow-hidden'>
      ...
      <div className="flex flex-col gap-y-[5vw]">
        ...
        <div id="statistics" className={`relative flex md:flex-row flex-col-reverse justify-center items-center gap-x-[3vw] md:gap-y-0 gap-y-[10vw] md:pt-[10vw] pt-[20vw] md:pb-0 pb-[10vw] overflow-hidden ${margin} select-none`}>
          <img
            src={main_svg_2}
            alt=""
            className="absolute -translate-x-[0.01vw] md:-translate-y-[5vw] -translate-y-[40vw] w-[200vw] h-[45vw] pointer-events-none select-none z-0"
            aria-hidden="true"
          />
          <img
            src={main_svg_3}
            alt=""
            className="absolute md:-translate-y-[5.5vw] -translate-y-[30vw] translate-x-[40vw] md:w-[25vw] w-[45vw] md:h-[25vw] h-[45vw] pointer-events-none select-none z-0"
            aria-hidden="true"
          />
          <div className='flex flex-row gap-x-[3vw]'>
            <div className='flex flex-col gap-x-[5vw] justify-center items-center'>
              <div className='flex flex-col items-center'>
                ...
                <span className='md:text-[0.8vw] text-[1.8vw] text-[#1A1A1A] font-medium'>Customers</span>
              </div>
              <div className='flex flex-col items-center'>
                <span className='md:text-[4vw] text-[8vw] font-bold bg-gradient-to-t from-[#4F378A] to-[#FF00E5] inline-block text-transparent bg-clip-text'>
                  <Counter
                ...
                <span className='md:text-[0.8vw] text-[1.8vw] text-[#1A1A1A] font-medium'>Global Partners</span>
              </div>
              <div className='flex flex-col items-center'>
                <span className='md:text-[4vw] text-[8vw] font-bold bg-gradient-to-t from-[#4F378A] to-[#FF00E5] inline-block text-transparent bg-clip-text'>
                  <Counter
                ...
                <span className='md:text-[0.8vw] text-[1.8vw] text-[#1A1A1A] font-medium'>Countries Covered</span>
              </div>
            </div>
            <div className='flex flex-col gap-x-[5vw] justify-center items-center'>
              <div className='flex flex-col items-center'>
                ...
                <span className='md:text-[0.8vw] text-[1.8vw] text-[#1A1A1A] font-medium'>Orders Processed</span>
              </div>
              <div className='flex flex-col items-center'>
                <span className='md:text-[4vw] text-[8vw] font-bold bg-gradient-to-t from-[#4F378A] to-[#FF00E5] inline-block text-transparent bg-clip-text'>
                  <Counter
                ...
                <span className='md:text-[0.8vw] text-[1.8vw] text-[#1A1A1A] font-medium'>Tech Enabled Warehouses</span>
              </div>
              <div className='flex flex-col items-center'>
                <span className='md:text-[4vw] text-[8vw] font-bold bg-gradient-to-t from-[#4F378A] to-[#FF00E5] inline-block text-transparent bg-clip-text'>
                  <Counter
                ...
                <span className='md:text-[0.8vw] text-[1.8vw] text-[#1A1A1A] font-medium'>Orders Fulfilled</span>
              </div>
            </div>
            <div className='flex flex-col gap-x-[5vw] justify-center items-center'>
              <div className='flex flex-col items-center'>
                ...
                <span className='md:text-[0.8vw] text-[1.8vw] text-[#1A1A1A] font-medium'>Logistics & Ecommerce Partners</span>
              </div>
              <div className='flex flex-col items-center'>
                <span className='md:text-[4vw] text-[8vw] font-bold bg-gradient-to-t from-[#4F378A] to-[#FF00E5] inline-block text-transparent bg-clip-text'>
                  <Counter
                ...
                <span className='md:text-[0.8vw] text-[1.8vw] text-[#1A1A1A] font-medium'>Trucks Operated</span>
              </div>
              <div className='flex flex-col items-center'>
                <span className='md:text-[4vw] text-[8vw] font-bold bg-gradient-to-t from-[#4F378A] to-[#FF00E5] inline-block text-transparent bg-clip-text'>
                  $
                ...
                <span className='md:text-[0.8vw] text-[1.8vw] text-[#1A1A1A] font-medium'>GMV Per Year</span>
              </div>
            </div>
          </div>
          <div className='flex flex-col'>
            <div className='flex flex-col md:items-start items-center md:gap-y-[0.5vw] gap-y-[1.5vw]'>
              ...
              <p className='md:text-[2vw] text-[6vw] text-[#1A1A1A] md:text-start text-center font-semibold md:leading-[2.5vw] leading-[7.5vw]'>
                Powered by our unified <br />network — delivering <br className='md:block hidden' />excellence through ShipX
              </p>
            </div>
          </div>
        </div>
        ...
        <div id="services" className={`md:h-screen h-auto relative flex flex-col gap-y-[1vw] justify-center items-center pt-[5vw] overflow-hidden ${margin}`}>
          <img
            src={main_svg_4}
            alt=""
          ...
          <p className='md:text-[2vw] text-[6vw] text-[#1A1A1A] text-center font-semibold md:leading-[2.5vw] leading-[7.5vw] select-none'>
            <p className='inline text-[#FF00E5]'>All in one platform</p> &ndash; ShipX aggregates cross-<br className='md:block hidden' />border solutions from Amilo & SG Link
          </p>
          <div className='flex md:flex-row flex-col gap-x-[2vw] justify-center items-center md:pt-0 pt-[5vw]'>
            <div className='flex flex-col md:gap-y-[1vw] gap-y-[4vw] md:w-[25vw] w-[65vw]'>
              <div className='flex flex-row'>
                <motion.div
                  whileHover={{ scale: 1.2 }}
                  whileTap={{ scale: 0.8 }}
                  className='flex flex-row w-full md:rounded-[1vw] rounded-[3vw] bg-white z-10 md:px-[2vw] px-[4vw] md:py-[0.5vw] py-[2vw] items-center justify-start md:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.05)] shadow-[0_0.5vw_1.5vw_rgba(255,0,229,0.15)] hover:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.35)] transition-shadow duration-500 ease-in-out cursor-pointer select-none'
                >
                  <img className='md:w-[2vw] w-[4vw] md:h-[2vw] h-[4vw]' src={main_icon_1} />
                  <span className='text-[#4F378A] font-semibold md:text-[1vw] text-[3vw] pl-[2vw]'>
                    Express Worldwide
                  </span>
                </motion.div>
              </div>
              <div className='flex flex-row'>
                <motion.div
                  ...
                  className='flex flex-row w-full md:rounded-[1vw] rounded-[3vw] bg-white z-10 md:px-[2vw] px-[4vw] md:py-[0.5vw] py-[2vw] items-center justify-start md:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.05)] shadow-[0_0.5vw_1.5vw_rgba(255,0,229,0.15)] hover:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.35)] transition-shadow duration-500 ease-in-out cursor-pointer select-none'
                >
                  <img className='md:w-[2vw] w-[4vw] md:h-[2vw] h-[4vw]' src={main_icon_2} />
                  <span className='text-[#4F378A] font-semibold md:text-[1vw] text-[3vw] pl-[2vw]'>
                    Economy Worldwide
                  </span>
                </motion.div>
              ...
              <div className='flex flex-row'>
                <motion.div
                  ...
                  className='flex flex-row w-full md:rounded-[1vw] rounded-[3vw] bg-white z-10 md:px-[2vw] px-[4vw] md:py-[0.5vw] py-[2vw] items-center justify-start md:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.05)] shadow-[0_0.5vw_1.5vw_rgba(255,0,229,0.15)] hover:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.35)] transition-shadow duration-500 ease-in-out cursor-pointer select-none'
                >
                  <img className='md:w-[2vw] w-[4vw] md:h-[2vw] h-[4vw]' src={main_icon_3} />
                  <span className='text-[#4F378A] font-semibold md:text-[1vw] text-[3vw] pl-[2vw]'>
              ...
              <div className='flex flex-row'>
                <motion.div
                  ...
                  className='flex flex-row w-full md:rounded-[1vw] rounded-[3vw] bg-white z-10 md:px-[2vw] px-[4vw] md:py-[0.5vw] py-[2vw] items-center justify-start md:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.05)] shadow-[0_0.5vw_1.5vw_rgba(255,0,229,0.15)] hover:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.35)] transition-shadow duration-500 ease-in-out cursor-pointer select-none'
                >
                  <img className='md:w-[2vw] w-[4vw] md:h-[2vw] h-[4vw]' src={main_icon_4} />
                  <span className='text-[#4F378A] font-semibold md:text-[1vw] text-[3vw] pl-[2vw]'>
              ...
              <div className='flex flex-row'>
                <motion.div
                  ...
                  className='flex flex-row w-full md:rounded-[1vw] rounded-[3vw] bg-white z-10 md:px-[2vw] px-[4vw] md:py-[0.5vw] py-[2vw] items-center justify-start md:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.05)] shadow-[0_0.5vw_1.5vw_rgba(255,0,229,0.15)] hover:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.35)] transition-shadow duration-500 ease-in-out cursor-pointer select-none'
                >
                  <img className='md:w-[2vw] w-[4vw] md:h-[2vw] h-[4vw]' src={main_icon_5} />
                  <span className='text-[#4F378A] font-semibold md:text-[1vw] text-[3vw] pl-[2vw]'>
              ...
              <div className='flex flex-row'>
                <motion.div
                  ...
                  className='flex flex-row w-full md:rounded-[1vw] rounded-[3vw] bg-white z-10 md:px-[2vw] px-[4vw] md:py-[0.5vw] py-[2vw] items-center justify-start md:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.05)] shadow-[0_0.5vw_1.5vw_rgba(255,0,229,0.15)] hover:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.35)] transition-shadow duration-500 ease-in-out cursor-pointer select-none'
                >
                  <img className='md:w-[2vw] w-[4vw] md:h-[2vw] h-[4vw]' src={main_icon_6} />
                  <span className='text-[#4F378A] font-semibold md:text-[1vw] text-[3vw] pl-[2vw]'>
                    Bulk Freight to USA
                  </span>
                </motion.div>
              ...
              <div className='flex flex-row'>
                <motion.div
                  ...
                  className='flex flex-row w-full md:rounded-[1vw] rounded-[3vw] bg-white z-10 md:px-[2vw] px-[4vw] md:py-[0.5vw] py-[2vw] items-center justify-start md:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.05)] shadow-[0_0.5vw_1.5vw_rgba(255,0,229,0.15)] hover:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.35)] transition-shadow duration-500 ease-in-out cursor-pointer select-none'
                >
                  <img className='md:w-[2vw] w-[4vw] md:h-[2vw] h-[4vw]' src={main_icon_7} />
                  <span className='text-[#4F378A] font-semibold md:text-[1vw] text-[3vw] pl-[2vw]'>
              ...
              <div className='flex flex-row'>
                <motion.div
                  ...
                  className='flex flex-row w-full md:rounded-[1vw] rounded-[3vw] bg-white z-10 md:px-[2vw] px-[4vw] md:py-[0.5vw] py-[2vw] items-center justify-start md:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.05)] shadow-[0_0.5vw_1.5vw_rgba(255,0,229,0.15)] hover:shadow-[0_0.5vw_1vw_rgba(255,0,229,0.35)] transition-shadow duration-500 ease-in-out cursor-pointer select-none'
                >
                  <img className='md:w-[2vw] w-[4vw] md:h-[2vw] h-[4vw]' src={main_icon_8} />
                  <span className='text-[#4F378A] font-semibold md:text-[1vw] text-[3vw] pl-[2vw]'>
                    Financing and Customer Service
                  </span>
                </motion.div>
              </div>
              <div className="flex flex-row gap-x-[1vw] md:text-[0.8vw] text-[2.6vw] font-normal justify-center items-center select-none">
                <div
                  className="
          ...
          <span className='text-[#63666D] md:text-[0.6vw] text-[2vw] text-center select-none md:pt-0 pt-[3vw]'>*Prices shown are starting prices only and may vary by country, specifications, and applicable conditions</span>
        </div>
        ...
        <div id="platform" className={`min-h-screen relative flex flex-col justify-center items-center py-[10vw] ${margin} overflow-hidden select-none`}>
          ...
          <div className='flex md:flex-row flex-col gap-x-[0.1vw] justify-center items-center'>
            <div className='flex flex-col gap-y-[1vw] md:justify-start justify-center md:items-start items-center'>
              ...
              <p className='md:text-[2.3vw] text-[6vw] font-semibold md:leading-[2.5vw] leading-[7.5vw] md:text-start text-center'>One window for all your <br />cross-border logistics needs</p>
              <p className='text-[#63666D] md:text-[0.8vw] text-[2.5vw] font-medium opacity-80 md:text-start text-center md:pt-0 pt-[3vw] md:pb-0 pb-[2vw]'>
                ShipX Brings Together Modern Cross-Border Platform Technology And Tech-<br className='md:block hidden' />Enabled Logistics Networks Into A Single, Easy-To-Use Solution.
              </p>
              <div className="flex flex-row gap-x-[1vw] md:text-[0.8vw] text-[2.6vw] font-normal justify-start items-center">
                <div
                  className="
                    bg-gradient-to-t from-[#4F378A] from-0% via-[#FF00E5] via-60% to-[#FF00E5] to-100%
                    bg-[length:100%_200%] bg-[position:0%_100%]
            ...
            <img
              className='md:w-[35vw] w-full md:h-[25vw] h-full'
              src={main_img_2}
            />
          </div>
          <div className='flex md:flex-row flex-col justify-center items-center'>
            <div className='flex flex-col justify-center items-center md:rounded-[2vw] rounded-[4vw] md:p-[2vw] p-[5vw] bg-white md:inset-shadow-[0_0_0.5vw_rgba(79,55,138,0.1)] inset-shadow-[0_0_3.5vw_rgba(79,55,138,0.1)]'>
              <span className='text-[#4D4D4D] md:text-[0.7vw] text-[2.4vw] font-medium'>Our Trusted Partners</span>
            ...
            <div className='flex flex-col justify-start items-center text-[#1A1A1A] md:text-[0.8vw] text-[2.4vw] font-medium md:w-[35vw] w-[80vw] md:gap-y-[1.5vw] gap-y-[4vw] md:pl-[5vw] pl-0 md:pr-[10vw] pr-0 md:pt-0 pt-[5vw]'>
              <div className='flex flex-row md:gap-x-[1vw] gap-x-[3vw] items-center w-full'>
                <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_2} />
                <p className='pl-[1vw]'>Manage Orders And Shipments Across <br className='md:block hidden' />ASEAN and Global Destinations</p>
              </div>
              <div className='flex flex-row md:gap-x-[1vw] gap-x-[3vw] items-center w-full'>
                <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_9} />
                <p className='pl-[1vw]'>Integrate Marketplaces Like Amazon, <br className='md:block hidden' />Shopee, Lazada, eBay, and Shopify</p>
              </div>
              <div className='flex flex-row md:gap-x-[1vw] gap-x-[3vw] items-center w-full'>
                <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_7} />
                <p className='pl-[1vw]'>Track Performance In Real Time, With <br className='md:block hidden' />Visibility Across Every Step</p>
              </div>
              <div className='flex flex-row md:gap-x-[1vw] gap-x-[3vw] items-center w-full'>
                <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_6} />
                <p className='pl-[1vw]'>Access Warehousing, Fulfillment, Freight, <br className='md:block hidden' />And Delivery From One Dashboard</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className='flex flex-col gap-y-[1vw] md:pt-0 pt-[5vw]'>
              <div className='flex md:flex-row flex-col justify-between md:items-center items-start gap-x-[4vw] md:gap-y-0 gap-y-[5vw] rounded-[2vw] shadow-[0_0.5vw_1vw_rgba(79,55,138,0.075)] md:pl-[2.5vw] pl-[5vw] md:pr-0 pr-[5vw] md:py-0 py-[5vw]'>
                <div className='flex flex-col'>
                  <span className='flex flex-row gap-x-[0.5vw] items-center md:text-[0.8vw] text-[2.2vw] text-[#4F378A] font-semibold bg-transparent md:rounded-[0.5vw] rounded-[1vw] md:px-[0.5vw] px-0 py-[0.2vw]'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#4F378A" viewBox="0 0 24 24" strokeWidth={0} stroke="currentColor" className="md:size-[0.7vw] size-[1.1vw]">
                      <path strokeLinecap="round" strokeLinejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
                    </svg>
                    Freight & Customs
                  </span>
                  <p className='md:text-[1.8vw] text-[4vw] text-[#1A1A1A] text-start font-semibold md:leading-[2.5vw] leading-[5vw]'>
                ...
                <img className='md:w-[20vw] w-[80vw] md:h-[14vw] h-[60vw] rounded-[2vw] shadow-[0_0.5vw_1vw_rgba(79,55,138,0.075)]' src={main_img_5} />
              </div>
              <div className='flex md:flex-row flex-col justify-between gap-x-[1.5vw] md:gap-y-0 gap-y-[3vw] md:text-[0.8vw] text-[2.4vw] md:pt-0 pt-[3vw]'>
                <div className='flex flex-row justify-start items-center shadow-[0_0.5vw_1vw_rgba(79,55,138,0.075)] md:pl-[2vw] pl-[5vw] pr-[3.5vw] md:py-[1.5vw] py-[3vw] rounded-[1.5vw]'>
                  <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_10} />
                ...
                <div className='flex flex-row justify-start items-center shadow-[0_0.5vw_1vw_rgba(79,55,138,0.075)] md:pl-[2vw] pl-[5vw] pr-[3.5vw] md:py-[1.5vw] py-[3vw] rounded-[1.5vw]'>
                  <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_11} />
                  <p className='font-semibold text-start md:pl-[1.5vw] pl-[3vw]'>
                ...
                <div className='flex flex-row justify-start items-center shadow-[0_0.5vw_1vw_rgba(79,55,138,0.075)] md:pl-[2vw] pl-[5vw] pr-[3.5vw] md:py-[1.5vw] py-[3vw] rounded-[1.5vw]'>
                  <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_12} />
                  <p className='font-semibold text-start md:pl-[1.5vw] pl-[3vw]'>
                    Customs Solutions <br />
                    <p className='text-[#63666D] text-normal'>
                      clearance, IOSS/VAT, duty <br className='md:block hidden' />
                      management
                    </p>
                  </p>
                </div>
          ...
          <div className='flex md:flex-row flex-col justify-between md:items-center items-start gap-x-[5vw]'>
            <div className='flex flex-col gap-y-[1vw] md:pt-0 pt-[3vw]'>
              <div className='flex md:flex-row flex-col-reverse justify-start md:items-center items-start gap-x-[4vw] md:gap-y-0 gap-y-[5vw] rounded-[2vw] shadow-[0_0.5vw_1vw_rgba(79,55,138,0.075)] md:p-0 p-[5vw]'>
                ...
                <div className='flex flex-col'>
                  ...
                  <p className='md:text-[1.8vw] text-[4vw] text-[#1A1A1A] text-start font-semibold md:leading-[2.5vw] leading-[5vw]'>
                    <p className='inline text-[#FF00E5]'>Strategic hubs</p> across Vietnam, <br />
              ...
              <div className='flex md:flex-row flex-col justify-between gap-x-[1.5vw] md:gap-y-0 gap-y-[3vw] md:text-[0.8vw] text-[2.4vw] md:pt-0 pt-[3vw]'>
                <div className='flex flex-row justify-start items-center shadow-[0_0.5vw_1vw_rgba(79,55,138,0.075)] md:pl-[2vw] pl-[5vw] pr-[3.5vw] md:py-[1.5vw] py-[3vw] rounded-[1.5vw]'>
                  <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_13} />
                  <p className='font-semibold text-start md:pl-[1.5vw] pl-[3vw]'>
                    Inventory Services <br />
                    <p className='text-[#63666D] text-normal'>
                      storage, pick & pack, returns <br className='md:block hidden' />
                      management
                    </p>
                  </p>
                </div>
                <div className='flex flex-row justify-start items-center shadow-[0_0.5vw_1vw_rgba(79,55,138,0.075)] md:pl-[2vw] pl-[5vw] pr-[3.5vw] md:py-[1.5vw] py-[3vw] rounded-[1.5vw]'>
                  <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_14} />
                  <p className='font-semibold text-start md:pl-[1.5vw] pl-[3vw]'>
                    Seamless Integrations <br />
                    <p className='text-[#63666D] text-normal'>
                      Shopify, Shopee, Lazada, eBay, <br className='md:block hidden' />
                      Amazon
                    </p>
                  </p>
                </div>
                <div className='flex flex-row justify-start items-center shadow-[0_0.5vw_1vw_rgba(79,55,138,0.075)] md:pl-[2vw] pl-[5vw] pr-[3.5vw] md:py-[1.5vw] py-[3vw] rounded-[1.5vw]'>
                  <img className='md:w-[2vw] w-[6vw] md:h-[2vw] h-[6vw]' src={main_icon_15} />
                  <p className='font-semibold text-start md:pl-[1.5vw] pl-[3vw]'>
            ...
            <div className='flex flex-col md:pt-0 pt-[10vw]'>
              <p className='text-[#63666D] md:text-[1vw] text-[4vw] text-center font-medium italic opacity-90'>
                Trusted Infrastructure And Smart <br className='md:block hidden' />
                Integrations That Make International <br className='md:block hidden' />
        ...
        <div id="network" className={`md:min-h-screen h-auto relative flex flex-col justify-center items-center pt-[16vw] pb-[5vw] ${margin} overflow-hidden select-none`}>
          <img
            src={main_svg_10}
            alt=""
            ...
            aria-hidden="true"
          />
          <div className='flex md:flex-row flex-col gap-x-[2vw] justify-center items-center w-full'>
            <p className='md:text-[2.3vw] text-[5vw] md:text-start text-center font-semibold md:leading-[3.5vw] leading-[6vw]'>
              Local presence, global corridors <br className='md:block hidden' />— <p className='inline text-[#FF00E5]'>the ShipX advantage</p>
            </p>
            <div className='flex flex-col gap-y-[1vw] md:pt-0 pt-[3vw]'>
              <div className='flex flex-row md:justify-start justify-center gap-x-[3vw]'>
                <span className='flex flex-row gap-x-[0.5vw] items-center md:text-[0.8vw] text-[2.6vw] text-white font-semibold bg-[#4F378A] md:rounded-[0.5vw] rounded-[2vw] md:px-[0.8vw] px-[1.8vw] py-[0.2vw]'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" viewBox="0 0 24 24" strokeWidth={0} stroke="currentColor" className="md:size-[0.5vw] size-[1vw]">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
                  </svg>
                  Our Offices
                </span>
                <div className="flex flex-row gap-x-[1vw] md:text-[0.8vw] text-[2.6vw] font-normal justify-center items-center">
                  <div
                    className="
                      bg-gradient-to-t from-[#4F378A] from-0% via-[#FF00E5] via-60% to-[#FF00E5] to-100%
                      bg-[length:100%_200%] bg-[position:0%_100%]
        ...
        <div id="contact-us" className="relative flex flex-col justify-center items-center md:pt-[15vw] pt-[10vw] overflow-hidden">
          <img
            src={main_svg_7}
            alt=""
          ...
          <p className='md:text-[2.3vw] text-[5vw] text-[#1A1A1A] text-center font-semibold md:leading-[2.5vw] leading-[6vw] mt-[1vw] md:mb-[8vw] mb-[15vw] select-none z-20'>
            Ready to take your products <p className='inline text-[#FF00E5]'>global?</p> <br />
            Let's talk.
          </p>
          <div className='relative flex md:flex-row flex-col justify-start items-center gap-x-[5vw] shadow-[0_0.5vw_2vw_rgba(255,0,229,0.15)] md:pl-[10vw] pl-[15vw] pr-[8vw] py-[8vw] rounded-t-[2vw] md:w-[70vw] w-[90vw] bg-white z-10'>
            <img
              src={main_svg_8}
              alt=""
              className="absolute md:-translate-x-[44vw] -translate-x-[65vw] -translate-y-[0vw] w-[200vw] md:h-[29vw] h-[70vh] pointer-events-none select-none z-0"
              aria-hidden="true"
            />
            <div className='flex flex-col md:w-[20vw] w-full md:text-[0.8vw] text-[2.3vw]'>
              <span className='text-[#0E0E0E] md:text-[1.5vw] text-[4vw] font-semibold select-none'>Contact Information</span>
              <span className='text-black md:text-[0.9vw] text-[2.5vw] font-normal mt-[1vw] select-none'>Let's partner and grow</span>
              <div className="flex md:flex-col flex-wrap md:gap-y-[1vw] gap-y-[5vw] md:mt-[3vw] mt-[5vw] md:gap-x-0 gap-x-[5vw]">
                {/* Contact Number */}
                <div className="flex flex-row items-center w-fit">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="#FF00E5" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#FF00E5" className="md:size-[1vw] size-[3vw]">
                ...
                {/* Email Address */}
                <div className="flex flex-row items-center w-fit">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#FF00E5" className="md:size-[1vw] size-[3vw]">
                ...
                <div className="flex flex-row items-center w-fit">
                  ...
                  <p className="md:pl-[1vw] pl-[3vw]">391B Orchard Road #22, <br />Ngee Ann City Singapore, 238874</p>
                </div>
              </div>
            </div>
            <ContactForm />
