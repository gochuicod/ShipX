    ...
    <>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="flex flex-col">
          ...
          <div
            className={`relative w-[100vw] ${margin} flex md:flex-row flex-col justify-center items-center md:gap-x-[3vw] gap-x-0 md:gap-y-0 gap-y-[10vw] md:pt-[5vw] pt-[10vw]`}
          >
            ...
            <div className="relative">
              ...
              <button
                ...
                className="
                  ...
                  flex flex-row md:gap-x-[1vw] gap-x-[3vw] justify-center items-center z-[10] lg:w-auto md:w-auto w-[55vw]
                "
              >
